 ...
 */
private void present_close_screen(CallbackListPtr* pcbl, ScreenPtr screen, void* unused)
{
 ...
 */
private void present_free_window_vblank(WindowPtr window)
{
 ...
 */
private void present_destroy_window(CallbackListPtr* pcbl, ScreenPtr pScreen, WindowPtr window)
{
    ScreenPtr screen = window.drawable.pScreen;
    present_screen_priv_ptr screen_priv = present_screen_priv(screen);
    present_window_priv_ptr window_priv = present_window_priv(window);
 ...
 */
private int present_config_notify(WindowPtr window, int x, int y, int w, int h, int bw, WindowPtr sibling)
{
    int ret = void;
    ScreenPtr screen = window.drawable.pScreen;
    present_screen_priv_ptr screen_priv = present_screen_priv(screen);
...
private void present_clip_notify(WindowPtr window, int dx, int dy)
{
    ScreenPtr screen = window.drawable.pScreen;
    present_screen_priv_ptr screen_priv = present_screen_priv(screen);
...
private int check_flip_visit(WindowPtr window, void* data)
{
    ScreenPtr screen = window.drawable.pScreen;
    present_screen_priv_ptr screen_priv = present_screen_priv(screen);
 ...
 */
int present_screen_init(ScreenPtr screen, present_screen_info_ptr info)
{
