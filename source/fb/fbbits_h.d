...
enum string WRITE2(string d,string n,string fg) = `(` ~ WRITE1!(d,n,fg) ~ `, ` ~ WRITE1!(d,`(` ~ n ~ `)+1`,fg) ~ `)`;
}

version (BITS4) {
enum string WRITE4(string d,string n,string fg) = `WRITE(cast(BITS4*) &((` ~ d ~ `)[` ~ WRITE_ADDR4!(n) ~ `]), cast(BITS4) (` ~ fg ~ `))`;
} else {
