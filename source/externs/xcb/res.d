 ...
 *
 */
xcb_res_query_client_ids_cookie_t xcb_res_query_client_ids(xcb_connection_t* c, uint num_specs, const(xcb_res_client_id_spec_t)* specs);
 ...
 * placed in the event queue.
 */
xcb_res_query_client_ids_cookie_t xcb_res_query_client_ids_unchecked(xcb_connection_t* c, uint num_specs, const(xcb_res_client_id_spec_t)* specs);
 ...
 *
 */
xcb_res_query_resource_bytes_cookie_t xcb_res_query_resource_bytes(xcb_connection_t* c, uint client, uint num_specs, const(xcb_res_resource_id_spec_t)* specs);
 ...
 * placed in the event queue.
 */
xcb_res_query_resource_bytes_cookie_t xcb_res_query_resource_bytes_unchecked(xcb_connection_t* c, uint client, uint num_specs, const(xcb_res_resource_id_spec_t)* specs);
