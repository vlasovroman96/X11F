...
public import externs.xcb.randr;
public import externs.xcb.xfixes;
public import externs.xcb.sync;
public import externs.xcb.dri3;
...
alias XCB_PRESENT_OPTION_SUBOPTIMAL = xcb_present_option_t.XCB_PRESENT_OPTION_SUBOPTIMAL;
alias XCB_PRESENT_OPTION_ASYNC_MAY_TEAR = xcb_present_option_t.XCB_PRESENT_OPTION_ASYNC_MAY_TEAR;
...
alias XCB_PRESENT_CAPABILITY_ASYNC_MAY_TEAR = xcb_present_capability_t.XCB_PRESENT_CAPABILITY_ASYNC_MAY_TEAR;
alias XCB_PRESENT_CAPABILITY_SYNCOBJ = xcb_present_capability_t.XCB_PRESENT_CAPABILITY_SYNCOBJ;
...
alias XCB_PRESENT_COMPLETE_MODE_SUBOPTIMAL_COPY = xcb_present_complete_mode_t.XCB_PRESENT_COMPLETE_MODE_SUBOPTIMAL_COPY;
...
enum XCB_PRESENT_PIXMAP_SYNCED = 5;

/**
 * @brief xcb_present_pixmap_synced_request_t
 **/
struct xcb_present_pixmap_synced_request_t {
    ubyte major_opcode;
    ubyte minor_opcode;
    ushort length;
    xcb_window_t window;
...
alias xcb_present_complete_notify_event_t = XCB_PACKED;
...
alias xcb_present_redirect_notify_event_t = XCB_PACKED_;
 ...
 */
xcb_present_query_version_cookie_t xcb_present_query_version_unchecked(xcb_connection_t* c, uint major_version, uint minor_version);
 ...
 */
xcb_void_cookie_t xcb_present_pixmap_checked(xcb_connection_t* c, xcb_window_t window, xcb_pixmap_t pixmap, uint serial, xcb_xfixes_region_t valid, xcb_xfixes_region_t update, short x_off, short y_off, xcb_randr_crtc_t target_crtc, xcb_sync_fence_t wait_fence, xcb_sync_fence_t idle_fence, uint options, ulong target_msc, ulong divisor, ulong remainder, uint notifies_len, const(xcb_present_notify_t)* notifies);
 ...
 *
 */
xcb_void_cookie_t xcb_present_pixmap(xcb_connection_t* c, xcb_window_t window, xcb_pixmap_t pixmap, uint serial, xcb_xfixes_region_t valid, xcb_xfixes_region_t update, short x_off, short y_off, xcb_randr_crtc_t target_crtc, xcb_sync_fence_t wait_fence, xcb_sync_fence_t idle_fence, uint options, ulong target_msc, ulong divisor, ulong remainder, uint notifies_len, const(xcb_present_notify_t)* notifies);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_present_notify_msc_checked(xcb_connection_t* c, xcb_window_t window, uint serial, ulong target_msc, ulong divisor, ulong remainder);
 ...
 *
 */
xcb_void_cookie_t xcb_present_notify_msc(xcb_connection_t* c, xcb_window_t window, uint serial, ulong target_msc, ulong divisor, ulong remainder);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_present_select_input_checked(xcb_connection_t* c, xcb_present_event_t eid, xcb_window_t window, uint event_mask);
 ...
 *
 */
xcb_void_cookie_t xcb_present_select_input(xcb_connection_t* c, xcb_present_event_t eid, xcb_window_t window, uint event_mask);
...
int xcb_present_pixmap_synced_sizeof(const(void)* _buffer, uint notifies_len);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_present_pixmap_synced_checked(xcb_connection_t* c, xcb_window_t window, xcb_pixmap_t pixmap, uint serial, xcb_xfixes_region_t valid, xcb_xfixes_region_t update, short x_off, short y_off, xcb_randr_crtc_t target_crtc, xcb_dri3_syncobj_t acquire_syncobj, xcb_dri3_syncobj_t release_syncobj, ulong acquire_point, ulong release_point, uint options, ulong target_msc, ulong divisor, ulong remainder, uint notifies_len, const(xcb_present_notify_t)* notifies);
 ...
 *
 */
xcb_void_cookie_t xcb_present_pixmap_synced(xcb_connection_t* c, xcb_window_t window, xcb_pixmap_t pixmap, uint serial, xcb_xfixes_region_t valid, xcb_xfixes_region_t update, short x_off, short y_off, xcb_randr_crtc_t target_crtc, xcb_dri3_syncobj_t acquire_syncobj, xcb_dri3_syncobj_t release_syncobj, ulong acquire_point, ulong release_point, uint options, ulong target_msc, ulong divisor, ulong remainder, uint notifies_len, const(xcb_present_notify_t)* notifies);
...
xcb_present_notify_iterator_t xcb_present_pixmap_synced_notifies_iterator(const(xcb_present_pixmap_synced_request_t)* R);
