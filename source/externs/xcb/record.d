 ...
 */
xcb_void_cookie_t xcb_record_create_context_checked(xcb_connection_t* c, xcb_record_context_t context, xcb_record_element_header_t element_header, uint num_client_specs, uint num_ranges, const(xcb_record_client_spec_t)* client_specs, const(xcb_record_range_t)* ranges);
 ...
 *
 */
xcb_void_cookie_t xcb_record_create_context(xcb_connection_t* c, xcb_record_context_t context, xcb_record_element_header_t element_header, uint num_client_specs, uint num_ranges, const(xcb_record_client_spec_t)* client_specs, const(xcb_record_range_t)* ranges);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_record_register_clients_checked(xcb_connection_t* c, xcb_record_context_t context, xcb_record_element_header_t element_header, uint num_client_specs, uint num_ranges, const(xcb_record_client_spec_t)* client_specs, const(xcb_record_range_t)* ranges);
 ...
 *
 */
xcb_void_cookie_t xcb_record_register_clients(xcb_connection_t* c, xcb_record_context_t context, xcb_record_element_header_t element_header, uint num_client_specs, uint num_ranges, const(xcb_record_client_spec_t)* client_specs, const(xcb_record_range_t)* ranges);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_record_unregister_clients_checked(xcb_connection_t* c, xcb_record_context_t context, uint num_client_specs, const(xcb_record_client_spec_t)* client_specs);
 ...
 *
 */
xcb_void_cookie_t xcb_record_unregister_clients(xcb_connection_t* c, xcb_record_context_t context, uint num_client_specs, const(xcb_record_client_spec_t)* client_specs);
