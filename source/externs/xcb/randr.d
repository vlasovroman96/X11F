...
public import externs.xcb.render;
...
alias xcb_randr_lease_t = uint;

/**
 * @brief xcb_randr_lease_iterator_t
 **/
struct xcb_randr_lease_iterator_t {
...
alias XCB_RANDR_NOTIFY_MASK_LEASE = xcb_randr_notify_mask_t.XCB_RANDR_NOTIFY_MASK_LEASE;
...
alias XCB_RANDR_NOTIFY_LEASE = xcb_randr_notify_t.XCB_RANDR_NOTIFY_LEASE;
...
struct xcb_randr_monitor_info_t {
    ...
    ushort width;
    ushort height;
    uint width_in_millimeters;
    uint height_in_millimeters;
}
...
enum XCB_RANDR_GET_MONITORS = 42;
...
enum XCB_RANDR_DELETE_MONITOR = 44;
 ...
 **/
struct xcb_randr_create_lease_cookie_t {
    uint sequence;
}

/** Opcode for xcb_randr_create_lease. */
enum XCB_RANDR_CREATE_LEASE = 45;

/**
 * @brief xcb_randr_create_lease_request_t
 **/
struct xcb_randr_create_lease_request_t {
    ubyte major_opcode;
    ubyte minor_opcode;
    ushort length;
    xcb_window_t window;
 ...
 **/
struct xcb_randr_create_lease_reply_t {
    ubyte response_type;
    ubyte nfd;
    ushort sequence;
    uint length;
...
enum XCB_RANDR_FREE_LEASE = 46;

/**
 * @brief xcb_randr_free_lease_request_t
 **/
struct xcb_randr_free_lease_request_t {
    ubyte major_opcode;
    ubyte minor_opcode;
    ushort length;
    xcb_randr_lease_t lid;
 ...
 **/
struct xcb_randr_lease_notify_t {
    xcb_timestamp_t timestamp;
    xcb_window_t window;
 ...
 **/
struct xcb_randr_lease_notify_iterator_t {
...
int* xcb_randr_configure_output_property_values(const(xcb_randr_configure_output_property_request_t)* R);
 ...
 *
 */
xcb_randr_get_output_property_cookie_t xcb_randr_get_output_property(xcb_connection_t* c, xcb_randr_output_t output, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length, ubyte _delete, ubyte pending);
 ...
 * placed in the event queue.
 */
xcb_randr_get_output_property_cookie_t xcb_randr_get_output_property_unchecked(xcb_connection_t* c, xcb_randr_output_t output, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length, ubyte _delete, ubyte pending);
...
ushort* xcb_randr_set_crtc_gamma_red(const(xcb_randr_set_crtc_gamma_request_t)* R);
...
ushort* xcb_randr_set_crtc_gamma_green(const(xcb_randr_set_crtc_gamma_request_t)* R);
...
ushort* xcb_randr_set_crtc_gamma_blue(const(xcb_randr_set_crtc_gamma_request_t)* R);
...
int* xcb_randr_configure_provider_property_values(const(xcb_randr_configure_provider_property_request_t)* R);
 ...
 *
 */
xcb_randr_get_provider_property_cookie_t xcb_randr_get_provider_property(xcb_connection_t* c, xcb_randr_provider_t provider, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length, ubyte _delete, ubyte pending);
 ...
 * placed in the event queue.
 */
xcb_randr_get_provider_property_cookie_t xcb_randr_get_provider_property_unchecked(xcb_connection_t* c, xcb_randr_provider_t provider, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length, ubyte _delete, ubyte pending);
 ...
 *
 */
xcb_randr_get_monitors_cookie_t xcb_randr_get_monitors(xcb_connection_t* c, xcb_window_t window, ubyte get_active);
 ...
 * placed in the event queue.
 */
xcb_randr_get_monitors_cookie_t xcb_randr_get_monitors_unchecked(xcb_connection_t* c, xcb_window_t window, ubyte get_active);
 ...
 *
 */
xcb_randr_create_lease_cookie_t xcb_randr_create_lease(xcb_connection_t* c, xcb_window_t window, xcb_randr_lease_t lid, ushort num_crtcs, ushort num_outputs, const(xcb_randr_crtc_t)* crtcs, const(xcb_randr_output_t)* outputs);
 ...
 * placed in the event queue.
 */
xcb_randr_create_lease_cookie_t xcb_randr_create_lease_unchecked(xcb_connection_t* c, xcb_window_t window, xcb_randr_lease_t lid, ushort num_crtcs, ushort num_outputs, const(xcb_randr_crtc_t)* crtcs, const(xcb_randr_output_t)* outputs);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_randr_free_lease_checked(xcb_connection_t* c, xcb_randr_lease_t lid, ubyte terminate);
 ...
 *
 */
xcb_void_cookie_t xcb_randr_free_lease(xcb_connection_t* c, xcb_randr_lease_t lid, ubyte terminate);
