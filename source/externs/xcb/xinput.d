...
alias xcb_input_event_type_base_t = ubyte;

/**
 * @brief xcb_input_event_type_base_iterator_t
 **/
struct xcb_input_event_type_base_iterator_t {
...
enum xcb_input_modifier_device_t {
    XCB_INPUT_MODIFIER_DEVICE_USE_X_KEYBOARD = 255
}
alias XCB_INPUT_MODIFIER_DEVICE_USE_X_KEYBOARD = xcb_input_modifier_device_t.XCB_INPUT_MODIFIER_DEVICE_USE_X_KEYBOARD;
...
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_KEY_CLICK_PERCENT = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_KEY_CLICK_PERCENT;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_PERCENT = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_PERCENT;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_PITCH = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_PITCH;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_DURATION = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_DURATION;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_LED = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_LED;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_LED_MODE = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_LED_MODE;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_KEY = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_KEY;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_AUTO_REPEAT_MODE = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_AUTO_REPEAT_MODE;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_STRING = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_STRING;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_INTEGER = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_INTEGER;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_ACCEL_NUM = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_ACCEL_NUM;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_ACCEL_DENOM = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_ACCEL_DENOM;
alias XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_THRESHOLD = xcb_input_change_feedback_control_mask_t.XCB_INPUT_CHANGE_FEEDBACK_CONTROL_MASK_THRESHOLD;
...
enum xcb_input_valuator_state_mode_mask_t {
    XCB_INPUT_VALUATOR_STATE_MODE_MASK_DEVICE_MODE_ABSOLUTE = 1,
    XCB_INPUT_VALUATOR_STATE_MODE_MASK_OUT_OF_PROXIMITY = 2
}
alias XCB_INPUT_VALUATOR_STATE_MODE_MASK_DEVICE_MODE_ABSOLUTE = xcb_input_valuator_state_mode_mask_t.XCB_INPUT_VALUATOR_STATE_MODE_MASK_DEVICE_MODE_ABSOLUTE;
alias XCB_INPUT_VALUATOR_STATE_MODE_MASK_OUT_OF_PROXIMITY = xcb_input_valuator_state_mode_mask_t.XCB_INPUT_VALUATOR_STATE_MODE_MASK_OUT_OF_PROXIMITY;
...
struct xcb_input_hierarchy_change_data_t {
    struct _Add_master {
        ...
        ubyte enable;
        char* name;
    }_Add_master add_master;
    struct _Remove_master {
        xcb_input_device_id_t deviceid;
        ubyte return_mode;
        ubyte pad1;
        xcb_input_device_id_t return_pointer;
        xcb_input_device_id_t return_keyboard;
    }_Remove_master remove_master;
    struct _Attach_slave {
        xcb_input_device_id_t deviceid;
        xcb_input_device_id_t master;
    }_Attach_slave attach_slave;
    struct _Detach_slave {
        xcb_input_device_id_t deviceid;
        ubyte[2] pad2;
    }_Detach_slave detach_slave;
}
...
alias XCB_INPUT_DEVICE_CLASS_TYPE_GESTURE = xcb_input_device_class_type_t.XCB_INPUT_DEVICE_CLASS_TYPE_GESTURE;
 ...
 **/
struct xcb_input_gesture_class_t {
    ushort type;
    ushort len;
    xcb_input_device_id_t sourceid;
    ubyte num_touches;
 ...
 **/
struct xcb_input_gesture_class_iterator_t {
...
alias XCB_INPUT_GRAB_TYPE_GESTURE_PINCH_BEGIN = xcb_input_grab_type_t.XCB_INPUT_GRAB_TYPE_GESTURE_PINCH_BEGIN;
alias XCB_INPUT_GRAB_TYPE_GESTURE_SWIPE_BEGIN = xcb_input_grab_type_t.XCB_INPUT_GRAB_TYPE_GESTURE_SWIPE_BEGIN;
...
enum xcb_input_more_events_mask_t {
    XCB_INPUT_MORE_EVENTS_MASK_MORE_EVENTS = 128
}
alias XCB_INPUT_MORE_EVENTS_MASK_MORE_EVENTS = xcb_input_more_events_mask_t.XCB_INPUT_MORE_EVENTS_MASK_MORE_EVENTS;
...
alias XCB_INPUT_CLASSES_REPORTED_MASK_OUT_OF_PROXIMITY = xcb_input_classes_reported_mask_t.XCB_INPUT_CLASSES_REPORTED_MASK_OUT_OF_PROXIMITY;
alias XCB_INPUT_CLASSES_REPORTED_MASK_DEVICE_MODE_ABSOLUTE = xcb_input_classes_reported_mask_t.XCB_INPUT_CLASSES_REPORTED_MASK_DEVICE_MODE_ABSOLUTE;
alias XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_VALUATORS = xcb_input_classes_reported_mask_t.XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_VALUATORS;
alias XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_BUTTONS = xcb_input_classes_reported_mask_t.XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_BUTTONS;
alias XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_KEYS = xcb_input_classes_reported_mask_t.XCB_INPUT_CLASSES_REPORTED_MASK_REPORTING_KEYS;
...
enum xcb_input_change_device_t {
    XCB_INPUT_CHANGE_DEVICE_NEW_POINTER = 0,
    XCB_INPUT_CHANGE_DEVICE_NEW_KEYBOARD = 1
}
alias XCB_INPUT_CHANGE_DEVICE_NEW_POINTER = xcb_input_change_device_t.XCB_INPUT_CHANGE_DEVICE_NEW_POINTER;
alias XCB_INPUT_CHANGE_DEVICE_NEW_KEYBOARD = xcb_input_change_device_t.XCB_INPUT_CHANGE_DEVICE_NEW_KEYBOARD;
...
enum xcb_input_barrier_flags_t {
    XCB_INPUT_BARRIER_FLAGS_POINTER_RELEASED = 1,
    XCB_INPUT_BARRIER_FLAGS_DEVICE_IS_GRABBED = 2
}
alias XCB_INPUT_BARRIER_FLAGS_POINTER_RELEASED = xcb_input_barrier_flags_t.XCB_INPUT_BARRIER_FLAGS_POINTER_RELEASED;
alias XCB_INPUT_BARRIER_FLAGS_DEVICE_IS_GRABBED = xcb_input_barrier_flags_t.XCB_INPUT_BARRIER_FLAGS_DEVICE_IS_GRABBED;
...
enum xcb_input_gesture_pinch_event_flags_t {
    XCB_INPUT_GESTURE_PINCH_EVENT_FLAGS_GESTURE_PINCH_CANCELLED = 1
}
alias XCB_INPUT_GESTURE_PINCH_EVENT_FLAGS_GESTURE_PINCH_CANCELLED = xcb_input_gesture_pinch_event_flags_t.XCB_INPUT_GESTURE_PINCH_EVENT_FLAGS_GESTURE_PINCH_CANCELLED;


/** Opcode for xcb_input_gesture_pinch_begin. */
enum XCB_INPUT_GESTURE_PINCH_BEGIN = 27;

/**
 * @brief xcb_input_gesture_pinch_begin_event_t
 **/
struct xcb_input_gesture_pinch_begin_event_t {
    ubyte response_type;
    ubyte extension;
    ushort sequence;
    uint length;
...
enum XCB_INPUT_GESTURE_PINCH_UPDATE = 28;

alias xcb_input_gesture_pinch_update_event_t = xcb_input_gesture_pinch_begin_event_t;

/** Opcode for xcb_input_gesture_pinch_end. */
enum XCB_INPUT_GESTURE_PINCH_END = 29;

alias xcb_input_gesture_pinch_end_event_t = xcb_input_gesture_pinch_begin_event_t;

enum xcb_input_gesture_swipe_event_flags_t {
    XCB_INPUT_GESTURE_SWIPE_EVENT_FLAGS_GESTURE_SWIPE_CANCELLED = 1
}
alias XCB_INPUT_GESTURE_SWIPE_EVENT_FLAGS_GESTURE_SWIPE_CANCELLED = xcb_input_gesture_swipe_event_flags_t.XCB_INPUT_GESTURE_SWIPE_EVENT_FLAGS_GESTURE_SWIPE_CANCELLED;


/** Opcode for xcb_input_gesture_swipe_begin. */
enum XCB_INPUT_GESTURE_SWIPE_BEGIN = 30;

/**
 * @brief xcb_input_gesture_swipe_begin_event_t
 **/
struct xcb_input_gesture_swipe_begin_event_t {
    ubyte response_type;
    ubyte extension;
    ushort sequence;
    uint length;
...
enum XCB_INPUT_GESTURE_SWIPE_UPDATE = 31;

alias xcb_input_gesture_swipe_update_event_t = xcb_input_gesture_swipe_begin_event_t;

/** Opcode for xcb_input_gesture_swipe_end. */
enum XCB_INPUT_GESTURE_SWIPE_END = 32;

alias xcb_input_gesture_swipe_end_event_t = xcb_input_gesture_swipe_begin_event_t;

/**
 * @brief xcb_input_event_for_send_t
 **/
union xcb_input_event_for_send_t {
 ...
 **/
struct xcb_input_event_for_send_iterator_t {
...
int xcb_input_input_info_info_serialize(void** _buffer, ubyte class_id, const(xcb_input_input_info_info_t)* _aux);

int xcb_input_input_info_info_unpack(const(void)* _buffer, ubyte class_id, xcb_input_input_info_info_t* _aux);

int xcb_input_input_info_info_sizeof(const(void)* _buffer, ubyte class_id);
...
int xcb_input_device_time_coord_sizeof(const(void)* _buffer, ubyte num_axes);

int* xcb_input_device_time_coord_axisvalues(const(xcb_input_device_time_coord_t)* R);

int xcb_input_device_time_coord_axisvalues_length(const(xcb_input_device_time_coord_t)* R, ubyte num_axes);

xcb_generic_iterator_t xcb_input_device_time_coord_axisvalues_end(const(xcb_input_device_time_coord_t)* R, ubyte num_axes);
...
int xcb_input_feedback_state_data_serialize(void** _buffer, ubyte class_id, const(xcb_input_feedback_state_data_t)* _aux);

int xcb_input_feedback_state_data_unpack(const(void)* _buffer, ubyte class_id, xcb_input_feedback_state_data_t* _aux);

int xcb_input_feedback_state_data_sizeof(const(void)* _buffer, ubyte class_id);
...
int xcb_input_feedback_ctl_data_serialize(void** _buffer, ubyte class_id, const(xcb_input_feedback_ctl_data_t)* _aux);

int xcb_input_feedback_ctl_data_unpack(const(void)* _buffer, ubyte class_id, xcb_input_feedback_ctl_data_t* _aux);

int xcb_input_feedback_ctl_data_sizeof(const(void)* _buffer, ubyte class_id);
...
int* xcb_input_valuator_state_valuators(const(xcb_input_valuator_state_t)* R);
...
int* xcb_input_input_state_data_valuator_valuators(const(xcb_input_input_state_data_t)* S);
...
int xcb_input_input_state_data_serialize(void** _buffer, ubyte class_id, const(xcb_input_input_state_data_t)* _aux);

int xcb_input_input_state_data_unpack(const(void)* _buffer, ubyte class_id, xcb_input_input_state_data_t* _aux);

int xcb_input_input_state_data_sizeof(const(void)* _buffer, ubyte class_id);
...
uint* xcb_input_device_state_data_resolution_resolution_values(const(xcb_input_device_state_data_t)* S);
...
uint* xcb_input_device_state_data_resolution_resolution_min(const(xcb_input_device_state_data_t)* S);
...
uint* xcb_input_device_state_data_resolution_resolution_max(const(xcb_input_device_state_data_t)* S);
...
int xcb_input_device_state_data_serialize(void** _buffer, ushort control_id, const(xcb_input_device_state_data_t)* _aux);

int xcb_input_device_state_data_unpack(const(void)* _buffer, ushort control_id, xcb_input_device_state_data_t* _aux);

int xcb_input_device_state_data_sizeof(const(void)* _buffer, ushort control_id);
...
uint* xcb_input_device_ctl_data_resolution_resolution_values(const(xcb_input_device_ctl_data_t)* S);
...
int xcb_input_device_ctl_data_serialize(void** _buffer, ushort control_id, const(xcb_input_device_ctl_data_t)* _aux);

int xcb_input_device_ctl_data_unpack(const(void)* _buffer, ushort control_id, xcb_input_device_ctl_data_t* _aux);

int xcb_input_device_ctl_data_sizeof(const(void)* _buffer, ushort control_id);
...
int xcb_input_change_device_property_items_serialize(void** _buffer, uint num_items, ubyte format, const(xcb_input_change_device_property_items_t)* _aux);

int xcb_input_change_device_property_items_unpack(const(void)* _buffer, uint num_items, ubyte format, xcb_input_change_device_property_items_t* _aux);
...
int xcb_input_get_device_property_items_serialize(void** _buffer, uint num_items, ubyte format, const(xcb_input_get_device_property_items_t)* _aux);

int xcb_input_get_device_property_items_unpack(const(void)* _buffer, uint num_items, ubyte format, xcb_input_get_device_property_items_t* _aux);
 ...
 *
 */
xcb_input_get_device_property_cookie_t xcb_input_get_device_property(xcb_connection_t* c, xcb_atom_t property, xcb_atom_t type, uint offset, uint len, ubyte device_id, ubyte _delete);
 ...
 * placed in the event queue.
 */
xcb_input_get_device_property_cookie_t xcb_input_get_device_property_unchecked(xcb_connection_t* c, xcb_atom_t property, xcb_atom_t type, uint offset, uint len, ubyte device_id, ubyte _delete);
...
int xcb_input_hierarchy_change_data_serialize(void** _buffer, ushort type, const(xcb_input_hierarchy_change_data_t)* _aux);

int xcb_input_hierarchy_change_data_unpack(const(void)* _buffer, ushort type, xcb_input_hierarchy_change_data_t* _aux);

int xcb_input_hierarchy_change_data_sizeof(const(void)* _buffer, ushort type);
...
uint* xcb_input_device_class_data_key_keys(const(xcb_input_device_class_data_t)* S);
...
uint* xcb_input_device_class_data_button_state(const(xcb_input_device_class_data_t)* S);
...
int xcb_input_device_class_data_serialize(void** _buffer, ushort type, const(xcb_input_device_class_data_t)* _aux);

int xcb_input_device_class_data_unpack(const(void)* _buffer, ushort type, xcb_input_device_class_data_t* _aux);

int xcb_input_device_class_data_sizeof(const(void)* _buffer, ushort type);
...
uint* xcb_input_xi_passive_ungrab_device_modifiers(const(xcb_input_xi_passive_ungrab_device_request_t)* R);
...
int xcb_input_xi_change_property_items_serialize(void** _buffer, uint num_items, ubyte format, const(xcb_input_xi_change_property_items_t)* _aux);

int xcb_input_xi_change_property_items_unpack(const(void)* _buffer, uint num_items, ubyte format, xcb_input_xi_change_property_items_t* _aux);
...
int xcb_input_xi_get_property_items_serialize(void** _buffer, uint num_items, ubyte format, const(xcb_input_xi_get_property_items_t)* _aux);

int xcb_input_xi_get_property_items_unpack(const(void)* _buffer, uint num_items, ubyte format, xcb_input_xi_get_property_items_t* _aux);
 ...
 *
 */
xcb_input_xi_get_property_cookie_t xcb_input_xi_get_property(xcb_connection_t* c, xcb_input_device_id_t deviceid, ubyte _delete, xcb_atom_t property, xcb_atom_t type, uint offset, uint len);
 ...
 * placed in the event queue.
 */
xcb_input_xi_get_property_cookie_t xcb_input_xi_get_property_unchecked(xcb_connection_t* c, xcb_input_device_id_t deviceid, ubyte _delete, xcb_atom_t property, xcb_atom_t type, uint offset, uint len);
...
uint* xcb_input_key_press_button_mask(const(xcb_input_key_press_event_t)* R);
...
uint* xcb_input_key_press_valuator_mask(const(xcb_input_key_press_event_t)* R);
...
uint* xcb_input_button_press_button_mask(const(xcb_input_button_press_event_t)* R);
...
uint* xcb_input_button_press_valuator_mask(const(xcb_input_button_press_event_t)* R);
...
uint* xcb_input_enter_buttons(const(xcb_input_enter_event_t)* R);
...
uint* xcb_input_raw_key_press_valuator_mask(const(xcb_input_raw_key_press_event_t)* R);
...
uint* xcb_input_raw_button_press_valuator_mask(const(xcb_input_raw_button_press_event_t)* R);
...
uint* xcb_input_touch_begin_button_mask(const(xcb_input_touch_begin_event_t)* R);
...
uint* xcb_input_touch_begin_valuator_mask(const(xcb_input_touch_begin_event_t)* R);
...
uint* xcb_input_raw_touch_begin_valuator_mask(const(xcb_input_raw_touch_begin_event_t)* R);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_input_send_extension_event_checked(xcb_connection_t* c, xcb_window_t destination, ubyte device_id, ubyte propagate, ushort num_classes, ubyte num_events, const(xcb_input_event_for_send_t)* events, const(xcb_input_event_class_t)* classes);
 ...
 *
 */
xcb_void_cookie_t xcb_input_send_extension_event(xcb_connection_t* c, xcb_window_t destination, ubyte device_id, ubyte propagate, ushort num_classes, ubyte num_events, const(xcb_input_event_for_send_t)* events, const(xcb_input_event_class_t)* classes);

xcb_input_event_for_send_t* xcb_input_send_extension_event_events(const(xcb_input_send_extension_event_request_t)* R);

int xcb_input_send_extension_event_events_length(const(xcb_input_send_extension_event_request_t)* R);

xcb_input_event_for_send_iterator_t xcb_input_send_extension_event_events_iterator(const(xcb_input_send_extension_event_request_t)* R);
