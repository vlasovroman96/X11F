...
ubyte* xcb_glx_render_data(const(xcb_glx_render_request_t)* R);
...
ubyte* xcb_glx_render_large_data(const(xcb_glx_render_large_request_t)* R);
...
ubyte* xcb_glx_vendor_private_data(const(xcb_glx_vendor_private_request_t)* R);
...
uint* xcb_glx_create_pixmap_attribs(const(xcb_glx_create_pixmap_request_t)* R);
...
uint* xcb_glx_create_pbuffer_attribs(const(xcb_glx_create_pbuffer_request_t)* R);
...
uint* xcb_glx_change_drawable_attributes_attribs(const(xcb_glx_change_drawable_attributes_request_t)* R);
...
uint* xcb_glx_create_window_attribs(const(xcb_glx_create_window_request_t)* R);
...
uint* xcb_glx_set_client_info_arb_gl_versions(const(xcb_glx_set_client_info_arb_request_t)* R);
...
uint* xcb_glx_create_context_attribs_arb_attribs(const(xcb_glx_create_context_attribs_arb_request_t)* R);
...
uint* xcb_glx_set_client_info_2arb_gl_versions(const(xcb_glx_set_client_info_2arb_request_t)* R);
 ...
 *
 */
xcb_glx_is_enabled_cookie_t xcb_glx_is_enabled(xcb_connection_t* c, xcb_glx_context_tag_t context_tag, uint capability);
 ...
 * placed in the event queue.
 */
xcb_glx_is_enabled_cookie_t xcb_glx_is_enabled_unchecked(xcb_connection_t* c, xcb_glx_context_tag_t context_tag, uint capability);
...
uint* xcb_glx_delete_textures_textures(const(xcb_glx_delete_textures_request_t)* R);
...
uint* xcb_glx_delete_queries_arb_ids(const(xcb_glx_delete_queries_arb_request_t)* R);
