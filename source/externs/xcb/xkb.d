...
int xcb_xkb_select_events_details_serialize(void** _buffer, ushort affectWhich, ushort clear, ushort selectAll, const(xcb_xkb_select_events_details_t)* _aux);

int xcb_xkb_select_events_details_unpack(const(void)* _buffer, ushort affectWhich, ushort clear, ushort selectAll, xcb_xkb_select_events_details_t* _aux);

int xcb_xkb_select_events_details_sizeof(const(void)* _buffer, ushort affectWhich, ushort clear, ushort selectAll);
...
int xcb_xkb_get_map_map_serialize(void** _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, const(xcb_xkb_get_map_map_t)* _aux);

int xcb_xkb_get_map_map_unpack(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, xcb_xkb_get_map_map_t* _aux);

int xcb_xkb_get_map_map_sizeof(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present);
...
int xcb_xkb_set_map_values_serialize(void** _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, const(xcb_xkb_set_map_values_t)* _aux);

int xcb_xkb_set_map_values_unpack(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, xcb_xkb_set_map_values_t* _aux);

int xcb_xkb_set_map_values_sizeof(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present);
...
int xcb_xkb_get_names_value_list_serialize(void** _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, const(xcb_xkb_get_names_value_list_t)* _aux);

int xcb_xkb_get_names_value_list_unpack(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, xcb_xkb_get_names_value_list_t* _aux);

int xcb_xkb_get_names_value_list_sizeof(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which);
...
int xcb_xkb_set_names_values_serialize(void** _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, const(xcb_xkb_set_names_values_t)* _aux);

int xcb_xkb_set_names_values_unpack(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, xcb_xkb_set_names_values_t* _aux);

int xcb_xkb_set_names_values_sizeof(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which);
...
int xcb_xkb_get_kbd_by_name_replies_types_map_serialize(void** _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, const(xcb_xkb_get_kbd_by_name_replies_types_map_t)* _aux);

int xcb_xkb_get_kbd_by_name_replies_types_map_unpack(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present, xcb_xkb_get_kbd_by_name_replies_types_map_t* _aux);

int xcb_xkb_get_kbd_by_name_replies_types_map_sizeof(const(void)* _buffer, ubyte nTypes, ubyte nKeySyms, ubyte nKeyActions, ushort totalActions, ubyte totalKeyBehaviors, ushort virtualMods, ubyte totalKeyExplicit, ubyte totalModMapKeys, ubyte totalVModMapKeys, ushort present);
...
int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_serialize(void** _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, const(xcb_xkb_get_kbd_by_name_replies_key_names_value_list_t)* _aux);

int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_unpack(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which, xcb_xkb_get_kbd_by_name_replies_key_names_value_list_t* _aux);

int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_sizeof(const(void)* _buffer, ubyte nTypes, uint indicators, ushort virtualMods, ubyte groupNames, ubyte nKeys, ubyte nKeyAliases, ubyte nRadioGroups, uint which);
...
int xcb_xkb_get_kbd_by_name_replies_serialize(void** _buffer, ushort reported, const(xcb_xkb_get_kbd_by_name_replies_t)* _aux);
