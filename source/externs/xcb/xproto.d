...
int xcb_create_window_value_list_serialize(void** _buffer, uint value_mask, const(xcb_create_window_value_list_t)* _aux);

int xcb_create_window_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_create_window_value_list_t* _aux);
 ...
 */
xcb_void_cookie_t xcb_create_window_checked(xcb_connection_t* c, ubyte depth, xcb_window_t wid, xcb_window_t parent, short x, short y, ushort width, ushort height, ushort border_width, ushort _class, xcb_visualid_t visual, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_create_window(xcb_connection_t* c, ubyte depth, xcb_window_t wid, xcb_window_t parent, short x, short y, ushort width, ushort height, ushort border_width, ushort _class, xcb_visualid_t visual, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_create_window_aux_checked(xcb_connection_t* c, ubyte depth, xcb_window_t wid, xcb_window_t parent, short x, short y, ushort width, ushort height, ushort border_width, ushort _class, xcb_visualid_t visual, uint value_mask, const(xcb_create_window_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_create_window_aux(xcb_connection_t* c, ubyte depth, xcb_window_t wid, xcb_window_t parent, short x, short y, ushort width, ushort height, ushort border_width, ushort _class, xcb_visualid_t visual, uint value_mask, const(xcb_create_window_value_list_t)* value_list);

void* xcb_create_window_value_list(const(xcb_create_window_request_t)* R);

int xcb_change_window_attributes_value_list_serialize(void** _buffer, uint value_mask, const(xcb_change_window_attributes_value_list_t)* _aux);

int xcb_change_window_attributes_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_change_window_attributes_value_list_t* _aux);

int xcb_change_window_attributes_value_list_sizeof(const(void)* _buffer, uint value_mask);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_window_attributes_checked(xcb_connection_t* c, xcb_window_t window, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_window_attributes(xcb_connection_t* c, xcb_window_t window, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_window_attributes_aux_checked(xcb_connection_t* c, xcb_window_t window, uint value_mask, const(xcb_change_window_attributes_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_window_attributes_aux(xcb_connection_t* c, xcb_window_t window, uint value_mask, const(xcb_change_window_attributes_value_list_t)* value_list);
...
int xcb_configure_window_value_list_serialize(void** _buffer, ushort value_mask, const(xcb_configure_window_value_list_t)* _aux);

int xcb_configure_window_value_list_unpack(const(void)* _buffer, ushort value_mask, xcb_configure_window_value_list_t* _aux);

int xcb_configure_window_value_list_sizeof(const(void)* _buffer, ushort value_mask);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_configure_window_checked(xcb_connection_t* c, xcb_window_t window, ushort value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_configure_window(xcb_connection_t* c, xcb_window_t window, ushort value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_configure_window_aux_checked(xcb_connection_t* c, xcb_window_t window, ushort value_mask, const(xcb_configure_window_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_configure_window_aux(xcb_connection_t* c, xcb_window_t window, ushort value_mask, const(xcb_configure_window_value_list_t)* value_list);
 ...
 *
 */
xcb_get_property_cookie_t xcb_get_property(xcb_connection_t* c, ubyte _delete, xcb_window_t window, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length);
 ...
 * placed in the event queue.
 */
xcb_get_property_cookie_t xcb_get_property_unchecked(xcb_connection_t* c, ubyte _delete, xcb_window_t window, xcb_atom_t property, xcb_atom_t type, uint long_offset, uint long_length);
...
int xcb_create_gc_value_list_serialize(void** _buffer, uint value_mask, const(xcb_create_gc_value_list_t)* _aux);

int xcb_create_gc_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_create_gc_value_list_t* _aux);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_create_gc_checked(xcb_connection_t* c, xcb_gcontext_t cid, xcb_drawable_t drawable, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_create_gc(xcb_connection_t* c, xcb_gcontext_t cid, xcb_drawable_t drawable, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_create_gc_aux_checked(xcb_connection_t* c, xcb_gcontext_t cid, xcb_drawable_t drawable, uint value_mask, const(xcb_create_gc_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_create_gc_aux(xcb_connection_t* c, xcb_gcontext_t cid, xcb_drawable_t drawable, uint value_mask, const(xcb_create_gc_value_list_t)* value_list);

void* xcb_create_gc_value_list(const(xcb_create_gc_request_t)* R);

int xcb_change_gc_value_list_serialize(void** _buffer, uint value_mask, const(xcb_change_gc_value_list_t)* _aux);

int xcb_change_gc_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_change_gc_value_list_t* _aux);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_gc_checked(xcb_connection_t* c, xcb_gcontext_t gc, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_gc(xcb_connection_t* c, xcb_gcontext_t gc, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_gc_aux_checked(xcb_connection_t* c, xcb_gcontext_t gc, uint value_mask, const(xcb_change_gc_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_gc_aux(xcb_connection_t* c, xcb_gcontext_t gc, uint value_mask, const(xcb_change_gc_value_list_t)* value_list);
...
int xcb_change_keyboard_control_value_list_serialize(void** _buffer, uint value_mask, const(xcb_change_keyboard_control_value_list_t)* _aux);

int xcb_change_keyboard_control_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_change_keyboard_control_value_list_t* _aux);

int xcb_change_keyboard_control_value_list_sizeof(const(void)* _buffer, uint value_mask);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_keyboard_control_checked(xcb_connection_t* c, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_keyboard_control(xcb_connection_t* c, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_change_keyboard_control_aux_checked(xcb_connection_t* c, uint value_mask, const(xcb_change_keyboard_control_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_change_keyboard_control_aux(xcb_connection_t* c, uint value_mask, const(xcb_change_keyboard_control_value_list_t)* value_list);
