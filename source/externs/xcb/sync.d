...
int xcb_sync_create_alarm_value_list_serialize(void** _buffer, uint value_mask, const(xcb_sync_create_alarm_value_list_t)* _aux);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_sync_create_alarm_checked(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_sync_create_alarm(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_sync_create_alarm_aux_checked(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(xcb_sync_create_alarm_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_sync_create_alarm_aux(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(xcb_sync_create_alarm_value_list_t)* value_list);

void* xcb_sync_create_alarm_value_list(const(xcb_sync_create_alarm_request_t)* R);

int xcb_sync_change_alarm_value_list_serialize(void** _buffer, uint value_mask, const(xcb_sync_change_alarm_value_list_t)* _aux);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_sync_change_alarm_checked(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_sync_change_alarm(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_sync_change_alarm_aux_checked(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(xcb_sync_change_alarm_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_sync_change_alarm_aux(xcb_connection_t* c, xcb_sync_alarm_t id, uint value_mask, const(xcb_sync_change_alarm_value_list_t)* value_list);
