...
public import externs.xcb.shape;
...
enum xcb_xfixes_client_disconnect_flags_t {
...
alias XCB_XFIXES_CLIENT_DISCONNECT_FLAGS_DEFAULT = xcb_xfixes_client_disconnect_flags_t.XCB_XFIXES_CLIENT_DISCONNECT_FLAGS_DEFAULT;
alias XCB_XFIXES_CLIENT_DISCONNECT_FLAGS_TERMINATE = xcb_xfixes_client_disconnect_flags_t.XCB_XFIXES_CLIENT_DISCONNECT_FLAGS_TERMINATE;


/** Opcode for xcb_xfixes_set_client_disconnect_mode. */
enum XCB_XFIXES_SET_CLIENT_DISCONNECT_MODE = 33;

/**
 * @brief xcb_xfixes_set_client_disconnect_mode_request_t
 **/
struct xcb_xfixes_set_client_disconnect_mode_request_t {
    ubyte major_opcode;
    ubyte minor_opcode;
    ushort length;
    uint disconnect_mode;
}

/**
 * @brief xcb_xfixes_get_client_disconnect_mode_cookie_t
 **/
struct xcb_xfixes_get_client_disconnect_mode_cookie_t {
    uint sequence;
}

/** Opcode for xcb_xfixes_get_client_disconnect_mode. */
enum XCB_XFIXES_GET_CLIENT_DISCONNECT_MODE = 34;

/**
 * @brief xcb_xfixes_get_client_disconnect_mode_request_t
 **/
struct xcb_xfixes_get_client_disconnect_mode_request_t {
    ubyte major_opcode;
    ubyte minor_opcode;
    ushort length;
}
 ...
 **/
struct xcb_xfixes_get_client_disconnect_mode_reply_t {
    ubyte response_type;
    ubyte pad0;
    ushort sequence;
    uint length;
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_create_region_checked(xcb_connection_t* c, xcb_xfixes_region_t region, uint rectangles_len, const(xcb_rectangle_t)* rectangles);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_create_region(xcb_connection_t* c, xcb_xfixes_region_t region, uint rectangles_len, const(xcb_rectangle_t)* rectangles);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_set_region_checked(xcb_connection_t* c, xcb_xfixes_region_t region, uint rectangles_len, const(xcb_rectangle_t)* rectangles);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_set_region(xcb_connection_t* c, xcb_xfixes_region_t region, uint rectangles_len, const(xcb_rectangle_t)* rectangles);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_set_cursor_name_checked(xcb_connection_t* c, xcb_cursor_t cursor, ushort nbytes, const(char)* name);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_set_cursor_name(xcb_connection_t* c, xcb_cursor_t cursor, ushort nbytes, const(char)* name);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_change_cursor_by_name_checked(xcb_connection_t* c, xcb_cursor_t src, ushort nbytes, const(char)* name);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_change_cursor_by_name(xcb_connection_t* c, xcb_cursor_t src, ushort nbytes, const(char)* name);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_create_pointer_barrier_checked(xcb_connection_t* c, xcb_xfixes_barrier_t barrier, xcb_window_t window, ushort x1, ushort y1, ushort x2, ushort y2, uint directions, ushort num_devices, const(ushort)* devices);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_create_pointer_barrier(xcb_connection_t* c, xcb_xfixes_barrier_t barrier, xcb_window_t window, ushort x1, ushort y1, ushort x2, ushort y2, uint directions, ushort num_devices, const(ushort)* devices);

ushort* xcb_xfixes_create_pointer_barrier_devices(const(xcb_xfixes_create_pointer_barrier_request_t)* R);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_xfixes_set_client_disconnect_mode_checked(xcb_connection_t* c, uint disconnect_mode);
 ...
 *
 */
xcb_void_cookie_t xcb_xfixes_set_client_disconnect_mode(xcb_connection_t* c, uint disconnect_mode);
