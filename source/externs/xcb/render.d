...
int xcb_render_create_picture_value_list_serialize(void** _buffer, uint value_mask, const(xcb_render_create_picture_value_list_t)* _aux);

int xcb_render_create_picture_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_render_create_picture_value_list_t* _aux);

int xcb_render_create_picture_value_list_sizeof(const(void)* _buffer, uint value_mask);
 ...
 */
xcb_void_cookie_t xcb_render_create_picture_checked(xcb_connection_t* c, xcb_render_picture_t pid, xcb_drawable_t drawable, xcb_render_pictformat_t format, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_render_create_picture(xcb_connection_t* c, xcb_render_picture_t pid, xcb_drawable_t drawable, xcb_render_pictformat_t format, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_render_create_picture_aux_checked(xcb_connection_t* c, xcb_render_picture_t pid, xcb_drawable_t drawable, xcb_render_pictformat_t format, uint value_mask, const(xcb_render_create_picture_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_render_create_picture_aux(xcb_connection_t* c, xcb_render_picture_t pid, xcb_drawable_t drawable, xcb_render_pictformat_t format, uint value_mask, const(xcb_render_create_picture_value_list_t)* value_list);

void* xcb_render_create_picture_value_list(const(xcb_render_create_picture_request_t)* R);

int xcb_render_change_picture_value_list_serialize(void** _buffer, uint value_mask, const(xcb_render_change_picture_value_list_t)* _aux);

int xcb_render_change_picture_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_render_change_picture_value_list_t* _aux);

int xcb_render_change_picture_value_list_sizeof(const(void)* _buffer, uint value_mask);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_render_change_picture_checked(xcb_connection_t* c, xcb_render_picture_t picture, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_render_change_picture(xcb_connection_t* c, xcb_render_picture_t picture, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_render_change_picture_aux_checked(xcb_connection_t* c, xcb_render_picture_t picture, uint value_mask, const(xcb_render_change_picture_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_render_change_picture_aux(xcb_connection_t* c, xcb_render_picture_t picture, uint value_mask, const(xcb_render_change_picture_value_list_t)* value_list);
...
xcb_rectangle_t* xcb_render_set_picture_clip_rectangles_rectangles(const(xcb_render_set_picture_clip_rectangles_request_t)* R);
...
uint* xcb_render_add_glyphs_glyphids(const(xcb_render_add_glyphs_request_t)* R);
...
ubyte* xcb_render_add_glyphs_data(const(xcb_render_add_glyphs_request_t)* R);
...
ubyte* xcb_render_composite_glyphs_8_glyphcmds(const(xcb_render_composite_glyphs_8_request_t)* R);
...
ubyte* xcb_render_composite_glyphs_16_glyphcmds(const(xcb_render_composite_glyphs_16_request_t)* R);
...
ubyte* xcb_render_composite_glyphs_32_glyphcmds(const(xcb_render_composite_glyphs_32_request_t)* R);
...
xcb_render_color_t* xcb_render_create_conical_gradient_colors(const(xcb_render_create_conical_gradient_request_t)* R);
