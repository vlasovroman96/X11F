module externs.xcb.screensaver;
@nogc nothrow:
extern(C): __gshared:
/*
 ...
 *
 */
xcb_screensaver_query_version_cookie_t xcb_screensaver_query_version(xcb_connection_t* c, ubyte client_major_version, ubyte client_minor_version);
 ...
 */
xcb_screensaver_query_version_cookie_t xcb_screensaver_query_version_unchecked(xcb_connection_t* c, ubyte client_major_version, ubyte client_minor_version);
...
int xcb_screensaver_set_attributes_value_list_serialize(void** _buffer, uint value_mask, const(xcb_screensaver_set_attributes_value_list_t)* _aux);

int xcb_screensaver_set_attributes_value_list_unpack(const(void)* _buffer, uint value_mask, xcb_screensaver_set_attributes_value_list_t* _aux);

int xcb_screensaver_set_attributes_value_list_sizeof(const(void)* _buffer, uint value_mask);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_screensaver_set_attributes_checked(xcb_connection_t* c, xcb_drawable_t drawable, short x, short y, ushort width, ushort height, ushort border_width, ubyte _class, ubyte depth, xcb_visualid_t visual, uint value_mask, const(void)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_screensaver_set_attributes(xcb_connection_t* c, xcb_drawable_t drawable, short x, short y, ushort width, ushort height, ushort border_width, ubyte _class, ubyte depth, xcb_visualid_t visual, uint value_mask, const(void)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_screensaver_set_attributes_aux_checked(xcb_connection_t* c, xcb_drawable_t drawable, short x, short y, ushort width, ushort height, ushort border_width, ubyte _class, ubyte depth, xcb_visualid_t visual, uint value_mask, const(xcb_screensaver_set_attributes_value_list_t)* value_list);
 ...
 *
 */
xcb_void_cookie_t xcb_screensaver_set_attributes_aux(xcb_connection_t* c, xcb_drawable_t drawable, short x, short y, ushort width, ushort height, ushort border_width, ubyte _class, ubyte depth, xcb_visualid_t visual, uint value_mask, const(xcb_screensaver_set_attributes_value_list_t)* value_list);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_screensaver_suspend_checked(xcb_connection_t* c, uint suspend);
 ...
 *
 */
xcb_void_cookie_t xcb_screensaver_suspend(xcb_connection_t* c, uint suspend);
