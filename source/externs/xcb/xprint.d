 ...
 *
 */
xcb_x_print_print_get_printer_list_cookie_t xcb_x_print_print_get_printer_list(xcb_connection_t* c, uint printerNameLen, uint localeLen, const(xcb_x_print_string8_t)* printer_name, const(xcb_x_print_string8_t)* locale);
 ...
 * placed in the event queue.
 */
xcb_x_print_print_get_printer_list_cookie_t xcb_x_print_print_get_printer_list_unchecked(xcb_connection_t* c, uint printerNameLen, uint localeLen, const(xcb_x_print_string8_t)* printer_name, const(xcb_x_print_string8_t)* locale);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_x_print_create_context_checked(xcb_connection_t* c, uint context_id, uint printerNameLen, uint localeLen, const(xcb_x_print_string8_t)* printerName, const(xcb_x_print_string8_t)* locale);
 ...
 *
 */
xcb_void_cookie_t xcb_x_print_create_context(xcb_connection_t* c, uint context_id, uint printerNameLen, uint localeLen, const(xcb_x_print_string8_t)* printerName, const(xcb_x_print_string8_t)* locale);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_x_print_print_put_document_data_checked(xcb_connection_t* c, xcb_drawable_t drawable, uint len_data, ushort len_fmt, ushort len_options, const(ubyte)* data, const(xcb_x_print_string8_t)* doc_format, const(xcb_x_print_string8_t)* options);
 ...
 *
 */
xcb_void_cookie_t xcb_x_print_print_put_document_data(xcb_connection_t* c, xcb_drawable_t drawable, uint len_data, ushort len_fmt, ushort len_options, const(ubyte)* data, const(xcb_x_print_string8_t)* doc_format, const(xcb_x_print_string8_t)* options);

ubyte* xcb_x_print_print_put_document_data_data(const(xcb_x_print_print_put_document_data_request_t)* R);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_x_print_print_select_input_checked(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint event_mask);
 ...
 *
 */
xcb_void_cookie_t xcb_x_print_print_select_input(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint event_mask);
 ...
 *
 */
xcb_x_print_print_get_one_attributes_cookie_t xcb_x_print_print_get_one_attributes(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint nameLen, ubyte pool, const(xcb_x_print_string8_t)* name);
 ...
 * placed in the event queue.
 */
xcb_x_print_print_get_one_attributes_cookie_t xcb_x_print_print_get_one_attributes_unchecked(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint nameLen, ubyte pool, const(xcb_x_print_string8_t)* name);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_x_print_print_set_attributes_checked(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint stringLen, ubyte pool, ubyte rule, uint attributes_len, const(xcb_x_print_string8_t)* attributes);
 ...
 *
 */
xcb_void_cookie_t xcb_x_print_print_set_attributes(xcb_connection_t* c, xcb_x_print_pcontext_t context, uint stringLen, ubyte pool, ubyte rule, uint attributes_len, const(xcb_x_print_string8_t)* attributes);
