 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_selinux_set_device_context_checked(xcb_connection_t* c, uint device, uint context_len, const(char)* context);
 ...
 *
 */
xcb_void_cookie_t xcb_selinux_set_device_context(xcb_connection_t* c, uint device, uint context_len, const(char)* context);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_selinux_set_property_create_context_checked(xcb_connection_t* c, uint context_len, const(char)* context);
 ...
 * saved for handling by xcb_request_check().
 */
xcb_void_cookie_t xcb_selinux_set_selection_create_context_checked(xcb_connection_t* c, uint context_len, const(char)* context);
