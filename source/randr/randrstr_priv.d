...
enum string VERIFY_RR_OUTPUT(string id, string ptr, string a) = `
    {
...
enum string VERIFY_RR_CRTC(string id, string ptr, string a) = `
    {
	int rc = dixLookupResourceByType(cast(void**)&(` ~ ptr ~ `), ` ~ id ~ `,
	                                 RRCrtcType, client, ` ~ a ~ `);
	if (rc != Success) {
...
enum string VERIFY_RR_MODE(string id, string ptr, string a) = `
    {
	int rc = dixLookupResourceByType(cast(void**)&(` ~ ptr ~ `), ` ~ id ~ `,
	                                 RRModeType, client, ` ~ a ~ `);
	if (rc != Success) {
...
enum string VERIFY_RR_PROVIDER(string id, string ptr, string a) = `
    {
        int rc = dixLookupResourceByType(cast(void**)&(` ~ ptr ~ `), ` ~ id ~ `,
...
enum string VERIFY_RR_LEASE(string id, string ptr, string a) = `
    {
        int rc = dixLookupResourceByType(cast(void**)&(` ~ ptr ~ `), ` ~ id ~ `,
