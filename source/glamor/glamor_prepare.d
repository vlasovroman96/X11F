...
private Bool glamor_prep_drawable_box(DrawablePtr drawable, glamor_access_t access, BoxPtr box)
{
    ScreenPtr screen = drawable.pScreen;
    glamor_screen_private* glamor_priv = glamor_get_screen_private(screen);
    PixmapPtr pixmap = glamor_get_drawable_pixmap(drawable);
    glamor_pixmap_private* priv = glamor_get_pixmap_private(pixmap);
    int gl_access = void, gl_usage = void;
...
Bool glamor_prepare_access_box(DrawablePtr drawable, glamor_access_t access, int x, int y, int w, int h)
{
    BoxRec box = void;
...
Bool glamor_prepare_access_picture_box(PicturePtr picture, glamor_access_t access, int x, int y, int w, int h)
{
    if (!picture || !picture.pDrawable)
        return TRUE;
