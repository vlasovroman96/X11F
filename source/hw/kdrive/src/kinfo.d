...
void KdCardInfoDispose(KdCardInfo* ci)
{
    KdCardInfo** prev = void;
...
void KdScreenInfoDispose(KdScreenInfo* si)
{
    KdCardInfo* ci = si.card;
    KdScreenInfo** prev = void;
...
void KdFreePointer(KdPointerInfo* pi)
{
    free(pi.name);
    free(pi.path);
